<%ST(A)%><$log_Author$><%ST(A)%><$log_viewCount$><%ST(A)%>
	...
	<%ST(A)%>
		<tr>
			...
			<td valign="top" width="60"><nobr><a href="article.asp?id=<$LogID$>#comm_top" title="评论"><$log_CommNums$></a> | <a href="trackback.asp?tbID=<$LogID$>" target="_blank" title="引用通告"><$log_QuoteNums$></a> | <span title="查看次数"><$log_viewC$></span></nobr></td>
		</tr>
   <%ST(A)%>
		<div class="Content">
			<div class="Content-top"><div class="ContentLeft"></div><div class="ContentRight"></div>
