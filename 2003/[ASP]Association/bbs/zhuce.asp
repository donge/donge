...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-width:0; border-collapse: collapse" bordercolor="#111111" width="94%">
    <tr>
      ...
      <img border="0" src="pic/9.gif" align="absbottom"><font color="#FFFFFF"><b>新 用 户 注 册</b></font></td>
...
<tr>
<td colspan="2" height="22" background="pic/0.gif">&nbsp;<b><font color="<%=c1%>">●必填资料：</font></b></td>
</tr>
<tr>
<td>
...
<tr>
<td><%=sty%>
<b>密码(最多20位)</b>：<br>请不要使用任何类似 '*'、' ' 或 HTML 字符</td>
<td>&nbsp;<input type=password name=password size=30 maxlength=20></td>
</tr>
<tr>
<td><%=sty%><b>重复密码(最多20位)</b>：<br>请再输一遍确认</td>
...
<tr>
<td colspan="2" height="30" align="center"><input type=submit value=我填好了，现在注册！ name=Submit>&nbsp;&nbsp; <input type=reset value=不行，还是重写吧！ name=Submit2></td>
</tr>
</table></center>
