...
response.write"<div align=center><center><table border=1 cellpadding=0 cellspacing=0 style='border-collapse:collapse; border-left-width:1px; border-right-width:1px; border-top-width:1px' bordercolor="&c1&" width='94%' id=AutoNumber5 height='27'><tr><td width=4% align=center background='pic/8.gif'><b><font color='#FFFFFF'>状态</font></b></td><td width=42% align=center background='pic/8.gif'><b><a target=_self href=list.asp?bd="&bd&"&pai=zhuti><font color='#FFFFFF'>主 题</font></a><font color='#FFFFFF'> ( 点小图标在新窗口浏览 )</font></b></td>"&_
"<td width=9% align=center background='pic/8.gif'><b><a target=_self href=list.asp?bd="&bd&"&pai=name><font color='#FFFFFF'>作 者</font></a></b></td><td width=9% align=center background='pic/8.gif'><b><font color='#FFFFFF'>回复/</font><a target=_self href=list.asp?bd="&bd&"&pai=hits><font color='#FFFFFF'>人气</font></a></b></td><td width=16% align=center background='pic/8.gif'><b><a target=_self href=list.asp?bd="&bd&"><font color='#FFFFFF'>最后更新时间</font></a></b></td><td width=9% align=center background='pic/8.gif'><b><font color='#FFFFFF'>最后回复</font></b></td></tr></table></center></div>"
i=1
do while not rs.eof
rrzz=kbbs(rs("zhuti"))
...
loop
rs.Close
response.write"<div align='center'><center><TABLE borderColor="&c1&" cellSpacing=0 cellPadding=0 width='94%' border=1 style='border-collapse: collapse; border-left-width: 1px; border-right-width: 1px; border-top-width: 1px'><TBODY><TR height=25><TD height=2><TABLE cellSpacing=0 cellPadding=3 width='100%' border=0 background='pic/8.gif' style='border-collapse: collapse; border-left-width:0; border-top-width:0; border-bottom-width:0'><TBODY><TR><TD><b><font color='#FFFFFF'><img border='0' src='pic/fl.gif'> 本论坛共有</font><font color='#00FFFF'> "&TotalPage&" </font><font color='#FFFFFF'>页,<font color='#00FFFF'> "&count&" </font>个话题，每页有<font color='#00FFFF'> "&pagesetup&" </font> 张贴子 >> ["
ii=PageCount-5
iii=PageCount+5
if ii < 1 then
ii=1
...
<%
response.write"<div align=center><center><table border=1 cellpadding=0 cellspacing=0 style='border-collapse:collapse; border-left-width:1px; border-right-width:1px; border-top-width:1px' bordercolor="&c1&" width='94%' height='27' ><tr><td width=100% height='27' background='pic/8.gif'><font color='#FFFFFF'>&nbsp;<b><img border='0' src='pic/tj.gif' align='absmiddle'> 在线统计：</b>目前论坛总共有 <b>"&lineno&"</b> 人在线。其中有 <b>"&usno&"</b> 位会员， <b>"&nusno&"</b> 位游客。 </font></td></tr></table></center></div>"&_
"<br><div align=center><center><table border=1 cellpadding=0 cellspacing=0 style='border-width:1; border-collapse:collapse' bordercolor="&c1&" width='94%' height=67><tr><td width=50% height=23 background='pic/8.gif'><img border='0' src='pic/9.gif' align='absbottom'><font color='#FFFFFF'><b>论坛帖子图例：</b></font></td><td width=50% height=23 background='pic/8.gif'><img border='0' src='pic/9.gif' align='absbottom'><font color='#FFFFFF'><b>论坛搜索：</b></font></td></tr><tr><td width=50% height=41>&nbsp;<img border=0 src=face/top.gif> 固定置顶的帖子 <img border=0 src=face/jing.gif> 精华的帖子 <img border=0 src=pic/hot.gif> 热门的帖子</td><form method=POST action='list.asp?bd="&bd&"&search=yes' target=_self><td width=50% height=41>&nbsp;查询字符：<input type=text name=find size=20>  <input type=submit value=提交 name=B1> <input type=reset value=重置 name=B2></td></form></tr></table></center></div>"
