...
<td width=30% background=pic/5.gif><img border=0 src=pic/9.gif align=absbottom><font color=#FFFFFF><b>用 户 信 息</b></font></td><td width=70% background=pic/7.gif><img border=0 src=pic/6.gif></td></tr></table></center></div>
<div align="center">
  <center>
...
<img align=absmiddle border="0" src="<%=rs("toupic")%>" width="<%=rs("ku")%>" height="<%=rs("ch")%>"> <a title='点击给<%=kbbs(myname)%>留言' href=mailcon.asp?menu=write&towho=<%=kbbs(myname)%>><img align=absmiddle border="0" src="pic/newmail.gif"> <b><%=kbbs(myname)%></b></a></td>
    ...
    <tr>
      ...
      <td width="462" height="25" colspan="2" background="pic/0.gif">&nbsp;<b><font color="<%=c1%>">论坛资料：</font></b></td>
    </tr>
    <tr>
