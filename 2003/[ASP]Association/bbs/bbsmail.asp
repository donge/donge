...
<div align="center">
  ...
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-left-width: 1px; border-right-width: 1px; border-top-width: 1px" bordercolor="<%=c1%>" width="94%">
    <tr>
      <td width="100%" height="28" colspan="5">&nbsp;<img border="0" src="pic/xie.gif"> <span lang="zh-cn">
...
<%set gh=myconn.execute("select top 1 toupic,ch,ku from user where name='"&rs("name")&"'")%><img src=<%=kbbs(gh("toupic"))%> border="0" width="<%=gh("ku")%>" height="<%=gh("ch")%>"></td>
      ...
      <blockquote><img src="pic/tl.gif" border="0"> <%rrr=rs("neirong")%><%=ubb(rrr)%><p></p><div align=right><img src="pic/fl.gif" border="0"> <%=rs("riqi")%></div></blockquote>
      </td>
    </tr>
  </table>
  </center>
