...
sqltext="select * from userinfo where flag=0 order by id desc" 
...
If rs.eof and rs.bof then 
   call showpages
   response.write "<p align='center'><font color='#ff0000'>还没非正式会员信息</font></p>"
   response.end
End if
...
Sub list()%><form method='POST' action='../admin/news1_Search.asp'>
            <TABLE cellSpacing=1 cellPadding=4 width=756 bgColor=#416327 height="136">
              ...
              <TR vAlign=top bgColor=#e1f0ff>
                <TD class=main2  height="18" width="734" bgcolor="#DEEBD6">非正式会员列表--&nbsp;           
        ...
        <center>                    
            ...
            <td width="29%" bgcolor="#398A00" align="center" height="19" class=main2 ><font color="#FFFFFF">姓名</font></td>                  
                      
            <td width="11%" bgcolor="#398A00" align="center" height="19" class=main2 ><font color="#FFFFFF">电话</font></td>                  
...
%>                  
        ...
        <center>                 
                      ...
                      <td width="11%" align="left" height="1"><%=rs("txtSex")%></td>                
                      <td width="29%" align="left" height="1"><%=rs("txtName")%></td>                
                      <td width="11%" align="left" height="1"><%=rs("txtTel")%></td>                
                      <td width="9%" align="left" height="1">                
                        <p align="left"><%=rs("txtType")%></td>                
                      <td width="9%" align="left" height="1">                
...
<tr><td >                         
<%                         
response.write "<form method=Post action='user0info.asp'>"                         
%>                          
...
<%                         
   ...
   If currentpage > 1 Then                         
      response.write "<a href='user0info.asp?&page="+cstr(1)+"'><font color='#000000'>首页</font></a><font color='#ffffff'><b>-</b></font>"                           
      Response.write "<a href='user0info.asp?page="+Cstr(currentpage-1)+"'><font color='#000000'>前页</font></a><font color='#ffffff'><b>-</b></font>"                         
   Else                         
   ...
   If currentpage < Rs.PageCount Then                         
      Response.write "<a href='user0info.asp?page="+Cstr(currentPage+1)+"'><font color='#000000'>后页</font></a><font color='#ffffff'><b>-</b></font>"                         
      Response.write "<a href='user0info.asp?page="+Cstr(Rs.PageCount)+"'><font color='#000000'>尾页</font></a>&nbsp;&nbsp;"                         
   Else                         
