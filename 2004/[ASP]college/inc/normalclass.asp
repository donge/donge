...
<meta content="沈阳工业大学,信息科学与工程学院,科技部" name=keywords>
<meta content="Powered By Donge"  name=description>
<Style>
...
A.head {FONT-SIZE: 12px; TEXT-DECORATION: none;COLOR: #cccccc; FONT-FAMILY:宋体,Tahoma;}
...
Body{SCROLLBAR-FACE-COLOR: #EEEEEE; SCROLLBAR-HIGHLIGHT-COLOR: #EEEEEE;SCROLLBAR-SHADOW-COLOR: #EEEEEE;  SCROLLBAR-3DLIGHT-COLOR: #000000; SCROLLBAR-ARROW-COLOR: #333333; SCROLLBAR-TRACK-COLOR: #EEEEEE; BACKGROUND-COLOR: #FFFFFF;OVERFLOW-Y: Auto; OVERFLOW-X: auto;FONT-SIZE: 12px; FONT-FAMILY:宋体,Tahoma;COLOR: #333333;}
P {LINE-HEIGHT: 150%}
...
input{FONT-SIZE: 12px;COLOR: #333333; FONT-FAMILY: Tahoma, 宋体 ; CURSOR: hand; }
textarea{FONT-SIZE: 12px;COLOR: #333333; FONT-FAMILY: Tahoma, 宋体 ; CURSOR: Cross; BACKGROUND-COLOR: #EEEEEE;}
select {FONT-SIZE: 12px;COLOR: #333333; FONT-FAMILY: Tahoma, 宋体 ; CURSOR: Cross; BACKGROUND-COLOR: #EEEEEE;}
...
%>
<TABLE width=760 height="150"  align=center cellPadding=0 cellSpacing=0 background="image/bg1.gif">
 <TR >
  <TD bgcolor="#FFFFFF" ><DIV id=playerDiv></DIV><DIV id=pageViewCell style="DISPLAY: none"></DIV><SPAN style="WIDTH: 760px; HEIGHT: 150px"><SPAN 
...
<TABLE align=center cellSpacing=0 cellPadding=0 width=760  border=0>
    <TR>
...
<TABLE align=center cellSpacing=0 cellPadding=0 width=760  border=0 bgcolor=#EEEEEE>
   <TR>
...
<TABLE align=center cellSpacing=0 cellPadding=0 width=760  border=0 height=400>
   <TR>
...
<TABLE width=760  border=0 align="center" cellPadding=0 cellSpacing=0 background="image/bg1.gif">
  	<TR>
    <TD align=center height=10></TD>
  </TR>
  	<TR>
    <TD height=20 align=center><span class="style1"></span><a href=# onClick="window.external.AddFavorite('<%=PageIndex%>','工大信息科学与工程学院')">加入收藏</a>  §  <a href=# onclick="var strHref=window.location.href;this.style.behavior='url(#default#homepage)';this.setHomePage('<%=PageIndex%>');">设为首页</a> §  <a href="mailto:<%=Normal(0)%>">联系我们</a>  §  <a href=admin.asp target=_blank>系统维护</a><span class="style1"></span></TD>
  </TR>
  	<TR>
    <TD align=center height=30>Copyright &copy; 2004 Inc. All Rights Reserved &nbsp; 科技部保留程序所有权利</TD>
  </TR>
</TABLE>
<%
ENd Sub
...
<TABLE width=100%  border=0 cellPadding=0 cellSpacing=0 background="image/bg1.gif">
  	<TR>
    <TD background=image/tline.gif  height=1 colspan=10></TD>
  </TR>
  	<TR>
...
ListPages="<table border=0 cellpadding=10 cellspacing=5 width=100% >"
...
End if
	...
	Do While Not Talers.Eof 
	 Maininfo=Maininfo&"<tr><td width=400><img src=image/arr.gif>&nbsp; <a href=show.asp?id="&Talers("l_id")&" target=_blank title='"&Talers("l_title")&"'>"&Talers("l_title")&"</a></td><td>["&Year(Talers("l_time"))&"/"&Month(Talers("l_time"))&"/"&Day(Talers("l_time"))&"] </td></tr>"
	i=i+1
If i>=Maxrecord Then
	Exit Do
End if
