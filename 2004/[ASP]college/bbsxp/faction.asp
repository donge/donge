...
sql="select * from faction where factionname='"&HTMLEncode(Request("faction"))&"'"
rs.Open sql,Conn
%>
...
if allname="" then message=message&"<li>帮派名称没有填写"
if tenet="" then message=message&"<li>帮派宗旨没有填写"
