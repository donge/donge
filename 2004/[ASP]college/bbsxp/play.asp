...
<tr class=a3>
<td height=25>&nbsp;<img src=images/Forum_nav.gif>&nbsp; <a href=main.asp><%=clubname%></a> → <a href="play.asp">社区赌场</a></td>
</tr>
</table><br>
...
if money > rs("money") then error2("你的金币不够！")
if money<10 or money>100 then error2("输入错误！赌注范围10-100")
if rs("userlife")<1 then error2("您没有体力了!")
end sub
...
<title>社区博彩</title>
<center>
<table width="97%" border="0" height="143" cellpadding="1" cellspacing="0" class=a2>
<tr align="center">
<td height="129">
<table border="0" width="100%" cellspacing="0" cellpadding="6"><tr>
<td width="50%" align="center" bgcolor="FFFFFF">警告：每次赌博，您的体力值会扣 1 ！
