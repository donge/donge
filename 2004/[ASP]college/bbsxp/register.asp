...
if instr(username,"	")>0 or instr(username,"&nbsp;")>0 or instr(username,"#")>0 or instr(username,"`")>0 or instr(username,"|")>0 or instr(username," ")>0 or instr(username,"　")>0 or Instr(username,"%")>0 or Instr(username,"&")>0 or Instr(username,"ヴ")>0 or Instr(username,"ヂ")>0 or Instr(username,"ゼ")>0 or Instr(username,"ヅ")>0 or Instr(username,"") or Instr(username,"+")>0 then
...
<tr class=a3>
<td height=25>&nbsp;<img src=images/Forum_nav.gif>&nbsp; <a href=main.asp><%=clubname%></a> → 注册新用户</td>
</tr>
</table><br>
