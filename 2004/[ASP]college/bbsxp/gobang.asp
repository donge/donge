...
<tr class=a3>
<td height=25>&nbsp;<img src=images/Forum_nav.gif>&nbsp; <a href=main.asp><%=clubname%></a> → <a href="Gobang.asp">五 子 棋</a></td>
</tr>
</table><br>
<%
...
if rs("userlife") < money then error2("您的体力不足！")

rs("money")=rs("money")-money
rs("userlife")=rs("userlife")-money
nowmoney=rs("money")
rs.update
rs.close
