...
<td align=right><%=banner%></td>
	...
	<table border="0" width="97%" align="center" cellspacing="1" cellpadding="4" class=a2>
		<tr class=a3>
			<td height="25">&nbsp;<img src=images/Forum_nav.gif>&nbsp; <a href=main.asp><%=clubname%></a> → <%ForumTree(followid)%><%=ForumTreeList%> <a href=ShowForum.asp?forumid=<%=forumid%>><%=bbsname%></a> → <a onclick=min_yuzi() target=message href="ShowPost.asp?id=<%=id%>"><%=Request("topic")%></a> → 编辑帖子</td>
		</tr>
	</table><br>
