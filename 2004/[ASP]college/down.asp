...
<tr bgcolor=#FFFFFF><td width=180 height=30>课件名称：<font color=#006600><%=Talers("l_title")%></font></td>
<td width=120>课件大小：<font color=#006600><%=Talers("l_size")%> KB</font></td><td width=*>上传时间：<font color=#006600><%=Talers("l_time")%></font></td></tr>
<tr bgcolor=#FFFFFF><td width=180><a href='
...
End If%>'><img src=image/down.gif alt='点击下载课件' width="90" height="20" border=0></a></td>
<td colspan=2>课件提供：<a href='mailto:<%=Talers("l_email")%>' class=list title="联系课件提供者"><%=Talers("l_postman")%></a></td></tr>
