...
<form name="form1" method="post" action="find01.asp">
...
Response.Write("<center>")
	...
	Response.Write("<td align=center><a  href='index01.asp?jlh=2&myjl="&myjl&"'>姓名</a></td>")
...
%>
   ...
   <a href="index01.asp"><font face="隶书" size="4" color="#FF0000">返回管理首页</font></a></center>