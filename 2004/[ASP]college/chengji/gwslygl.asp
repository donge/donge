...
close();
 ...
 <body topmargin=0 leftmargin=0 rightmargin=0 bgcolor="#fef4d9">
  <center>
  <font face="华文行楷" size="6" color="#FF0000"><b>学生成绩详情查看</b></font><br>
  
  
 
  
<IMG SRC="showimg.asp?xh=<%=xh%>" height='160' width='140'></a></td>
  ...
  <table width="100%" cellpadding=4 cellspacing=0 bgcolor=#FFCCCC height="1" style="border-collapse: collapse" bordercolor="#FF0000" bordercolorlight="#FF0000" bordercolordark="#FF0000" border="1">
    ...
    %> 
        ...
        <tr>
         ...
         <p align="center"><font size="2">密码</font></td>
         <td width="334" height="13" align="center">
         <p align="center"><font size="2"><%=rs("xsmm")%></font></td>
         <td width="149" height="1" align="center">
       ...
       <tr>
        ...
        <tr>
         ...
         <td width="149" height="1" align="center">
         <p align="center"><font size="2">籍贯</font> </td>
         <td width="340" height="1" colspan="3" align="center">
         <p align="center"><font size="2"><%=rs("jg")%> </font>
</td>
       </tr>

     <tr>
         <td width="145" height="1" align="center">
         <p align="center"><font size="2">政治面貌</font> </td>
         <td width="334" height="1" align="center">
         <p align="center"><font size="2"><%=rs("zzmm")%> </font>
</td>
         <td width="149" height="1" align="center">
         <p align="center"><font size="2">毕业证书号</font> </td>
         <td width="340" height="1" colspan="3" align="center">
         <p align="center"><font size="2"><%=rs("byzs")%> </font>
</td>
       </tr>

     <tr>
         <td width="145" height="1" align="center">
         <p align="center"><font size="2">出生日期</font> </td>
         <td width="334" height="1" align="center">
         <p align="center"><font size="2"><%=rs("csrq")%> </font>
</td>
         <td width="149" height="1" align="center">
         <p align="center"><font size="2">入学时间</font> </td>
         <td width="340" height="1" colspan="3" align="center">
         <p align="center"><font size="2"><%=rs("rxsj")%> </font>
</td>
       </tr>
       ...
       <tr>
         <td width="145" height="1" align="center">
         <p align="center"><font size="2">毕业时间</font> </td>
         <td width="334" height="1" align="center">
         <p align="center"><font size="2"><%=rs("bysj")%> </font>
</td>
         <td width="149" height="1" align="center">
         <p align="center"><font size="2">学位</font> </td>
         <td width="340" height="1" colspan="3" align="center">
         <p align="center"><font size="2"><%=rs("sw")%></font>
</td>
       </tr>
       ...
       <tr>
         <td width="145" height="1" align="center">
         <p align="center"><font size="2">奖励</font> </td>
         <td width="823" height="1" align="center" colspan="5">
         <p align="center"><font size="2"><%=rs("jl")%> </font>
</td>
       </tr>
       ...
       <tr>
         <td width="145" height="1" align="center">
         <p align="center"><font size="2">处分</font> </td>
         <td width="823" height="1" align="center" colspan="5">
         <p align="center"><font size="2"><%=rs("cf")%> </font>
</td>
       </tr>
