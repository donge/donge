...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <center>
        ...
        <a href='index01.asp?myjl=<%=10%>'>10条</a> &nbsp;&nbsp;&nbsp;&nbsp;

        <a href='index01.asp?myjl=<%=20%>'>20条</a> &nbsp;&nbsp;&nbsp;&nbsp;
        
        <a href='index01.asp?myjl=<%=50%>'>50条</a> &nbsp;&nbsp;&nbsp;&nbsp;

        <a href='index01.asp?myjl=<%=100%>'>100条</a> &nbsp;&nbsp;&nbsp;&nbsp;
        
        <a href='index01.asp?myjl=<%=total%>'>全部</a>
</center>
...
Response.Write("<center>")
	...
	Response.Write("<td align=center><a  href='index01.asp?jlh=1&myjl="&myjl&"'>学号</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=2'>姓名</a></td>")
	Response.Write("<td align=center>性别</td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=3&myjl="&myjl&"'>部门或专业</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=4&myjl="&myjl&"'>班级名称</a></td>")
    Response.Write("<td align=center><a  href='index01.asp?jlh=5&myjl="&myjl&"'>出生日期</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=6&myjl="&myjl&"'>家庭住址</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=7&myjl="&myjl&"'>入学时间</a></td>")
    Response.Write("<td align=center><a  href='index01.asp?jlh=8&myjl="&myjl&"'>毕业证书号</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=9&myjl="&myjl&"'>籍贯</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=10&myjl="&myjl&"'>政治面貌</a></td>")
	Response.Write("<td align=center><a  href='index01.asp?jlh=11&myjl="&myjl&"'>毕业时间</a></td>")
...
%>
        <a href=index01.asp?page=<%=1%>&jlh=<%=jlh%>&myjl=<%=myjl%>>首页</a> 
        <%
end if
%>
...
%>
        <a href=index01.asp?page=<%=page-10%>&jlh=<%=jlh%>&myjl=<%=myjl%>>前10页</a> 
        <%
end if
%>
...
%>
        <a href=index01.asp?page=<%=page-1%>&jlh=<%=jlh%>&myjl=<%=myjl%>>上一页</a> 
        <%
end if
%>
        <%
...
response.write "[<a href=index01.asp?page="&j&"&jlh="&jlh&"&myjl="&myjl&">"&j&"</a>]"
next
...
response.write  "[<a href='index01.asp?page="&rs.pagecount&"&jlh="&jlh&"&myjl="&myjl&"' title='最后一页'>尾页</a>]"
end if
end if
...
if page<rs.pagecount   then%>
        <a href='index01.asp?page=<%=page+1%>&jlh=<%=jlh%>&myjl=<%=myjl%>'>下一页</a> 
        <%
end if
...
<form name="form2" method="post" action="find01.asp?myjl=<%=myjl%>">
