...
sql="SELECT * from cxb where zybj like '%"&zybj&"%' Order by "&sj&" desc" 
set rs=server.createobject("adodb.recordset")
rs.open sql,conn,3,3

sqlmax="SELECT max("&sj&") from cxb where zybj like '%"&zybj&"%'" 
set rsmax=server.createobject("adodb.recordset")
rsmax.Open Sqlmax,conn,1,1

sqlmin="SELECT min("&sj&") from cxb where zybj like '%"&zybj&"%'" 
set rsmin=server.createobject("adodb.recordset")
rsmin.Open Sqlmin,conn,1,1

sqlavg="SELECT avg("&sj&") As pjf from cxb where zybj like '%"&zybj&"%'" 
set rsavg=server.createobject("adodb.recordset")
rsavg.Open Sqlavg,conn,1,1

sqljg="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">="&mf&"*.6" 
set rsjg=server.createobject("adodb.recordset")
rsjg.Open Sqljg,conn,1,1

sqljg140="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=140" 
set rsjg140=server.createobject("adodb.recordset")
rsjg140.Open Sqljg140,conn,1,1

sqljg130="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=130 and "&sj&"<140" 
set rsjg130=server.createobject("adodb.recordset")
rsjg130.Open Sqljg130,conn,1,1

sqljg120="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=120 and "&sj&"<130" 
set rsjg120=server.createobject("adodb.recordset")
rsjg120.Open Sqljg120,conn,1,1

sqljg110="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=110 and "&sj&"<120" 
set rsjg110=server.createobject("adodb.recordset")
rsjg110.Open Sqljg110,conn,1,1

sqljg100="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=100 and "&sj&"<110" 
set rsjg100=server.createobject("adodb.recordset")
rsjg100.Open Sqljg100,conn,1,1

sqljg90="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=90 and "&sj&"<100" 
set rsjg90=server.createobject("adodb.recordset")
rsjg90.Open Sqljg90,conn,1,1

sqljg80="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=80 and "&sj&"<90" 
set rsjg80=server.createobject("adodb.recordset")
rsjg80.Open Sqljg80,conn,1,1

sqljg70="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=70 and "&sj&"<80" 
set rsjg70=server.createobject("adodb.recordset")
rsjg70.Open Sqljg70,conn,1,1

sqljg60="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=60 and "&sj&"<70" 
set rsjg60=server.createobject("adodb.recordset")
rsjg60.Open Sqljg60,conn,1,1

sqljg50="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=50 and "&sj&"<60" 
set rsjg50=server.createobject("adodb.recordset")
rsjg50.Open Sqljg50,conn,1,1

sqljg40="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=40 and "&sj&"<50" 
set rsjg40=server.createobject("adodb.recordset")
rsjg40.Open Sqljg40,conn,1,1

sqljg30="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=30 and "&sj&"<40" 
set rsjg30=server.createobject("adodb.recordset")
rsjg30.Open Sqljg30,conn,1,1

sqljg20="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=20 and "&sj&"<30" 
set rsjg20=server.createobject("adodb.recordset")
rsjg20.Open Sqljg20,conn,1,1

sqljg10="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&">=10 and "&sj&"<20" 
set rsjg10=server.createobject("adodb.recordset")
rsjg10.Open Sqljg10,conn,1,1

sqljg0="SELECT count("&sj&") As pjf from cxb where zybj like '%"&zybj&"%' and "&sj&"<10" 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
          ...
          <div align="center"><b><font color=red>单科成绩分析</font></b></div>      
