...
sql="select * from senddate where (recipientusername=" & sqlstr(oabusyusername) & " or (recipientusername='所有人' and recipientuserdept=" & sqlstr(oabusyuserdept) & ")) and sender<>" & sqlstr(oabusyusername) & " and reid=0 order by id desc"
if request("lookfor")="yes" then sql="select * from senddate where (recipientusername=" & sqlstr(oabusyusername) & " or (recipientusername='所有人' and recipientuserdept=" & sqlstr(oabusyuserdept) & ")) and sender<>" & sqlstr(oabusyusername) & " and reid=0 and inputdate between " & "#" & mydate & "# and #" & mydate1 & "# order by id desc"
'response.write sql
rs.open sql,conn,1
...
<tr>
<td align=center><b>公文标题</b></td><td align=center width=30><b>附件</b></td><td align=center width=100><b>发送者所在部门</b></td><td align=center width=60><b>发送者</b></td><td align=center width=150><b>发送日期</b></td>
</tr>
<%
for ipage=1 to rs.pagesize
%>
<tr>
<td><a href="showdate.asp?id=<%=rs("id")%>" target="_blank"><%=rs("title")%></a></td><td align="center">
<%
if rs("filename")<>"" then
%>
