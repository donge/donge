...
<tr>
<td width="30" align="center"><input type="submit" value="删除" name="detel" onclick="return window.confirm('你确定要删除通告吗？');"></td><td align=center><b>通告标题</b></td><td align=center><b>发布日期</b></td>
</tr>
<%
for ipage=1 to rs.pagesize
%>
<tr>
<td align="center"><input type="checkbox" name="delid" value=<%=rs("id")%>></td><td><a href="shownotice.asp?id=<%=rs("id")%>" target="_blank"><%=rs("title")%></a></td>
