...
@keihin = ("第一地獄カイーナ","帝邪紫光劍","龙王破山剑·逆鲮断","天上天下念動爆碎劍","雷射光束槍","光束波(爱莉丝測試系統ALICE）","反應彈","黄金剑","２連装米加流粒子砲","念力试作飞翔型光束剑");
...
方法是什麽呢，自己試驗。<p>
1．只有得到礦石或者高達尼姆合金才能製造<br>
2．越高級的武器就越南製造出來<br><p>
<table>
HTML
...
else{dbmclose %P;&UNLOCK;&ERROR('原因不明就失敗了。');}
...
<table $TABLE_STYLE>
<tr>
<td colspan=2 bgcolor=$TABLE_COLOR2>可以製造的</td></tr>
HTML
$i = 0;
