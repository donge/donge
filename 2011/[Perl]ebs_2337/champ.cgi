...
<br><br>
<center><div class=up1 onClick="MenuClick();" onmousedown=this.className='down' id="startmenu" style="position:absolute; z-index:1"><img border="0" src="$IMG_FOLDER4/champ.gif" alt="打开登机舱 / 关闭登机舱"></div></center>
...
print "<B>武器与技能检定</B></SPAN></TD></TR><TR>";
...
<tr><td width=100% bgcolor="#FFFFFF">
<center>
<font color=#787986><b>擂台指令</b></font><br>
<input type=submit name="b_mode" value="挑战擂主" $STYLE_B1 onClick="document.FM.cmd.value='BATTLE_2';Move();"><br>
