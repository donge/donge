...
$bairitu="2";             #奖励黄金(钱)增加倍率（１X 100～200×倍率）
$maxsts="50";            #能力最大值（默认５０、改造对应）
$prize="0";               #初期奖励黄金(钱)
$timer = "2";             #能够使用时间的间隔（秒）
#
...
<br><br>
<center><div class=up1 onClick="MenuClick();" onmousedown=this.className='down' id="startmenu" style="position:absolute; z-index:1"><img border="0" src="$IMG_FOLDER4/wars.gif" alt="打开登机舱 / 关闭登机舱"></div></center>
...
print "<B>機器狀態資料</B></SPAN></TD></TR><TR>";
...
WORL:{
	...
	if ($Pl_W[7] =~ m/1/){
		...
		if (rand(255) > 240){print "<font color=#8000ff>敌机命中系统被破坏</font><br>\n";$VS_VALUES[22]--;}
	}
	if ($Pl_W[7] =~ m/2/ && rand(255) > 240){print "<font color=#ff0080>$VS_VALUES[3]战斗不\能力\</font><br>\n";$VS_VALUES[25]=1;}
	if ($Vs_W[7] =~ m/2/ && rand(255) > 240){print "<font color=#ff0080>$PL_VALUES[3]战斗不\能力\</font><br>\n";$PL_VALUES[25]=1;}
	...
	if(int($VS_WLV/$WEAPON_LVUP) > int($WLDUMMYvs/$WEAPON_LVUP) && $VS_WLV < $MAX_WEAPONLV*100){
		print "<font color=#f7e957>$YOUSAINM的$Pl_W[0]升级</font><br>\n";
...
if ($ResultBattle==0){
        ...
        open(OUT,">$winforder$winfile");
	print OUT $VALS;
	close(OUT);
        chmod(0666,"$winforder$winfile");
	...
	</td><input id=ccSeeURL name=ccSeeURL type=hidden value='$SCRIPTNM'>
<input id=ccSeeFormInputCharset name=ccSeeFormInputCharset type=hidden value='1'>
<input id=ccSeeFormOrigitalCharset name=ccSeeFormOrigitalCharset type=hidden value='4'>
</form>
	END_OF_HTML
...
sub LOG01{
	&HEADER;
        &DBM_INPORT(C);
print"<center><BR>地球区域势力  围图<BR><BR><table><tr>";
        $i=0;
...
print"<td bgcolor=$CCOLOR[$i]><font >●</font></td><td><b>$CNAME[$i]</b></td>";
...
print"<tr></table>";
	...
	&LOCK;
        ...
        foreach $cno (0 .. $i){
        if($CNAME[$cno] eq $c_5[$no]){$areacolor[$no]="$CCOLOR[$cno]";last;}
        }
...
<table>
<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=$areacolor[10]><font color=$areacolor[10]><a href="#TOP" title="$c_5[10] 贝尔法斯特">●</a></font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[8]><font color=$areacolor[8]><a href="#TOP" title="$c_5[8] 奥德萨">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[6]><font color=$areacolor[6]><a href="#TOP" title="$c_5[6] 北京">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[1]><font color=$areacolor[1]><a href="#TOP" title="$c_5[1] 纽约">●</a></font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=$areacolor[2]><font color=$areacolor[2]><a href="#TOP" title="$c_5[2] 加里福尼亚">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[7]><font color=$areacolor[7]><a href="#TOP" title="$c_5[7] 马得拉斯">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=$areacolor[4]><font color=$areacolor[4]><a href="#TOP" title="$c_5[4] 夏威夷">●</a></font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[3]><font color=$areacolor[3]><a href="#TOP" title="$c_5[3] 扎布罗">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[9]><font color=$areacolor[9]><a href="#TOP" title="$c_5[9] 乞力马扎罗">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>

<tr><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=$areacolor[5]><font color=$areacolor[5]><a href="#TOP" title="$c_5[5] 托灵顿">●</a></font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=green><font color=green>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td><td bgcolor=skyblue><font color=skyblue>●</font></td></tr>
...
if($c_5[1] eq $c_5[2] and $c_5[2] eq $c_5[3] and $c_5[3] eq $c_5[4] and $c_5[4] eq $c_5[5] and $c_5[5] eq $c_5[6] and $c_5[6] eq $c_5[7] and $c_5[7] eq $c_5[8] and $c_5[8] eq $c_5[9] and $c_5[9] eq $c_5[10]){
print "<br><br>月<br><br><table><tr><td bgcolor=black><font color=black>●</font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=black><font color=black>●</font></td></tr><tr><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=silver><font color=silver>●</font></td></tr><tr><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=$areacolor[0]><font color=$areacolor[0]><a href=\"#TOP\" title=\"$c_5[0] 格兰纳达薄呢\">●</a></font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=silver><font color=silver>●</font></td></tr><tr><td bgcolor=black><font color=black>●</font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=silver><font color=silver>●</font></td><td bgcolor=black><font color=black>●</font></td></tr></table>";
}
        print "</center>";
