...
{
	var unit_id     = "1425506";
	var client_ip   = "220.181.141.181";
	var server_time = "1319247329";
	var verify_code = "5a36096a";
	var type        = "2";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.alimama.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1425506/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
