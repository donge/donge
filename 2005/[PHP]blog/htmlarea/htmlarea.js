...
HTMLArea.Config = function () {
	...
	this.pageStyle = "body { background-color: #fff; font-family: verdana,sans-serif; font-size: 9pt; margin: 1px;}";
	...
	this.toolbar = [
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "insertflash", "insertmedia", "insertseparator","separator",
		   "about" ]
		];
	...
	this.btnList = {
		...
		insertflash: [ "Insert A Flash", "/images/insert_flash.gif", false, function(e) {e.execCommand("insertflash");}],
		insertmedia: [ "Insert Multimedia Object", "/images/insert_media.gif", false, function(e) {e.execCommand("insertmedia");}],
		insertseparator: [ "Description Ends Here", "/images/insert_separator.gif", false, function(e) {e.execCommand("insertseparator");}],
...
//Flash Insertion by Bob Shen 2004-11-6
HTMLArea.prototype._insertFlash = function() {
	var editor = this;	// for nested functions
	this._popupDialog("insert_flash.php", function(param) {
		if (!param) {	// user must have pressed Cancel
			return false;
		}
...
// Called when the user clicks on "_insertFlash" button
//WMP/REAL Insertion by Bob Shen 2004-11-6
HTMLArea.prototype._insertMedia = function() {
	var editor = this;	// for nested functions
	this._popupDialog("insert_media.php", function(param) {
		if (!param) {	// user must have pressed Cancel
			return false;
		}
		if (!param["f_url"]) {
...
// Called when the user clicks on "_insertSeparator" button
HTMLArea.prototype._insertSeparator = function() {
	var editor = this;	// for nested functions
	editor.insertHTML("[separator]");
	return true;
};
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID.toLowerCase()) {
	    ...
	    case "insertseparator": this._insertSeparator(); break;
