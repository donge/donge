...
function onOK() {
  ...
  var fields = ["f_url", "f_auto", "f_width", "f_height"];
...
<div class="title">$langaer[1]</div>

<form action="" method="get">
<table border="0" width="100%" style="padding: 0px; margin: 0px">
  <tbody>
  <tr>
    <td style="width: 7em; text-align: right">Flash URL:</td>
...
<input type="text" name="height" id="f_height" size="6" value="300"
title="Height" />
