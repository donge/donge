...
function showpage(totalnumber,maxperpage,filename)
  ...
  if CurrentPage<2 then
    ...
    response.write "<a href=news.asp?page=1&txtitle="&keyword&">首页</a>&nbsp;"
    response.write "<a href=news.asp?page="&CurrentPage-1&"&txtitle="&keyword&">上页</a>&nbsp;"
  end if
  if n-currentpage<1 then
    response.write "下页 尾页"
  else
    response.write "<a href=news.asp?page="&(CurrentPage+1)&"&txtitle="&keyword&">"
    response.write "下页</a> <a href=news.asp?page="&n&"&txtitle="&keyword&">尾页</a>"
  end if
...
%> 
      ...
      <form name="searchtitle" method="POST" action="news.asp">
        <p align=center>新闻标题： 
          <input class=stedit type="text" name="txtitle" size="15" maxlength="30">
          <input class=stbtm type="submit" value="查 询" name="title">
          <a href="addnews.asp">发布新闻</a> </p>
      </form>
      <p align=center>&nbsp; 
    </td>
  </tr>
